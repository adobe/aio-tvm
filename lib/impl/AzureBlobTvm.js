...
class AzureBlobTvm extends Tvm {
  ...
  async _generateCredentials (params) {
    ...
    const privateContainerURL = azure.ContainerURL.fromServiceURL(serviceURL, privateContainerName)
    ...
    azureUtil.addAccessPolicyIfNotExists(privateContainerURL, params.azureStorageAccount, params.azureStorageAccessKey)
